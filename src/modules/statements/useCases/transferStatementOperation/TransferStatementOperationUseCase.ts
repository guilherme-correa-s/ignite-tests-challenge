...
import { ITransferStatementOperationDTO } from "./ITrasnferStatementOperation"
...
export class TransferOperationUseCase {
  ...
  async execute({ user_id, sender_id, description, amount }: ITransferStatementOperationDTO): Promise<Statement> {
